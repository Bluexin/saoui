    ...
    if (Debug.enabled) {
      try {      
        ...
        String[] specialTypesStr={
          ...
          "gnu.jel.reflect.String"                      // 28 0x1C
        };
...
//            Debug.println("specialClasses["+j+"]="+specialClasses[j]);
        ...
        char[][] specialMds={
          ...
          {20+100,0,0},        // java.lang.Boolean(boolean)           | 29
          {21+100,0,1},        // java.lang.Byte(byte)                 | 30
          {22+100,0,2},        // java.lang.Character(char)            | 31
          {23+100,0,3},        // java.lang.Short(short)               | 32
          {24+100,0,4},        // java.lang.Integer(int)               | 33
          {25+100,0,5},        // java.lang.Long(long)                 | 34
          {26+100,0,6},        // java.lang.Float(float)               | 35
          {27+100,0,7},        // java.lang.Double(double)             | 36
        };
        ...
        //                      Z   B   C   S   I   J   F   D
        byte[] arrayTypeCodes={ 4,  8,  5,  9, 10, 11,  6,  7};
        tables.put("arrayTypeCodes",arrayTypeCodes);

        //                         Z     B     C     S     I     J     F      D      L
        int[] arrayStoreCodes={ 0x54, 0x54, 0x55, 0x56, 0x4f, 0x50, 0x51,  0x52,  0x53};
        tables.put("arrayStoreCodes",arrayStoreCodes);
