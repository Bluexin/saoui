...
class DeathParticleData() : IParticleData {
    ...
    override fun writeToNetwork(buffer: PacketBuffer) {
        buffer.writeFloat(r)
        buffer.writeFloat(g)
        buffer.writeFloat(b)
    }
    ...
    companion object {
        ...
        val DESERIALIZER: IDeserializer<DeathParticleData> = object : IDeserializer<DeathParticleData> {
            ...
            override fun fromNetwork(@Nonnull type: ParticleType<DeathParticleData?>, buf: PacketBuffer): DeathParticleData {
