 ...
 * @author Bluexin
 */
open class IconLabelElement(icon: IIcon, open var label: ITextComponent = "".toTextComponent(), pos: Vec2d = Vec2d.ZERO, override val description: MutableList<String> = mutableListOf()) : IconElement(icon, pos, width = 84, height = 18) {
