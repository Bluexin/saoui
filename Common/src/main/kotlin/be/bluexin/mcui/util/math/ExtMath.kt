...
fun fastSqrt(value: Double): Double = Math.sqrt(value)
...
fun Int.roundDownBy(m: Int): Int = if (this >= 0) {
    (this / m) * m
} else {
    ((this - m + 1) / m) * m
}
...
fun Int.roundUpBy(m: Int): Int = if (this >= 0) {
    ((this + m - 1) / m) * m
} else {
    (this / m) * m
}
...
fun Int.roundBy(m: Int): Int = if ((this % m) > m / 2) {
    this + m - this % m
} else {
    this - this % m
}
...
/** round n down to nearest multiple of m */
fun Long.roundDownBy(m: Long): Long = if (this >= 0) {
    (this / m) * m
} else {
    ((this - m + 1) / m) * m
}
...
/** round n up to nearest multiple of m */
fun Long.roundUpBy(m: Long): Long = if (this >= 0) {
    ((this + m - 1) / m) * m
} else {
    (this / m) * m
}
...
/** round n to nearest multiple of m */
fun Long.roundBy(m: Long): Long = if ((this % m) > m / 2) {
    this + m - this % m
} else {
    this - this % m
}
