...
enum class IconCore : IIcon {
    ...
    override fun glDraw(x: Int, y: Int, z: Float) {
        ...
        GLCore.glTexturedRectV2(x.toDouble(), y.toDouble(), width = 16.0, height = 16.0, srcX = 0.0, srcY = 0.0, srcWidth = 256.0, srcHeight = 256.0)
    ...
    override val rl by lazy { ResourceLocation(MODID, "textures/menu/icons/${name.lowercase(Locale.getDefault())}.png") }
}
