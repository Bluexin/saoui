 ...
 * @author Bluexin
 */
open class HudDrawContext(player: Player = Client.player!!, val mc: Minecraft = Client.minecraft, override var itemRenderer: ItemRenderer = Client.minecraft.itemRenderer) :
    IHudDrawContext {
    /*
    Feel free to add anything you'd need here.
     */
    private val username: String = player.displayName.string
    override val fontRenderer: Font = GLCore.glFont
    ...
    private var context: MutableMap<String, CValue<*>?> = mutableMapOf()

    override fun pushContext(context: MutableMap<String, CValue<*>?>) {
