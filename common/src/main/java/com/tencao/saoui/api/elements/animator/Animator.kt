...
class Animator {
    ...
    init {
        animators.add(this)
        GuiEvent.RENDER_HUD.register(::renderTick)
    ...
    companion object {
        ...
        val screenPartialTicks: Float
            get() = screenTicks + Client.minecraft.frameTime

        @JvmStatic
        val worldPartialTicks: Float
            get() = if (Client.minecraft.isPaused) {
                worldTicks + Client.minecraft.pausePartialTick
            } else {
                worldTicks + Client.minecraft.frameTime
            }
        ...
        fun renderTick(poseStack: PoseStack, float: Float) {
            animators.forEach { it.update() }
        }

        @JvmStatic
        fun tick(minecraft: Minecraft) {
            if (!minecraft.isPaused) worldTicks++
            screenTicks++
        }
