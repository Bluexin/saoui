 ...
 * @author Bluexin
 */
public class EventInitStatsProvider {
    private PlayerStatsProvider implementation;

    public EventInitStatsProvider(PlayerStatsProvider implementation) {
     ...
     */
    public PlayerStatsProvider getImplementation() {
     ...
     */
    public void setImplementation(PlayerStatsProvider provider) {
