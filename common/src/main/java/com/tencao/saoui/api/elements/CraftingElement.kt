...
class CraftingElement : IconLabelElement(IconCore.CRAFTING, "guiCrafting".translate()) {
/*
    var init: Boolean = false

    val EMPTY = object : IconLabelElement(icon = IconCore.NONE, label = I18n.get("gui.empty")) {
    ...
    fun getTabName(tab: Creativ): String {
