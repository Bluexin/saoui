    ...
    companion object {
        ...
        val easeInElastic = object : PenningEasing() {
            override fun invoke(progress: Float): Float {
                ...
                val s = p / 4
                t -= 1
                return -(a * 2.0.pow((10 * t).toDouble()).toFloat() * sin((t * d - s) * (2 * Math.PI.toFloat()) / p)) + b
            }
        }
        ...
        val easeOutElastic = object : PenningEasing() {
            override fun invoke(progress: Float): Float {
                ...
                val a = c
                val s = p / 4
                return a * 2.0.pow((-10 * t).toDouble()).toFloat() * sin((t * d - s) * (2 * Math.PI.toFloat()) / p) + c + b
            }
        }
        ...
        val easeInOutElastic = object : PenningEasing() {
            override fun invoke(progress: Float): Float {
                ...
                val s = p / 4
                t -= 1
                if (t < 1) return -.5f * (a * 2.0.pow((10 * t).toDouble()).toFloat() * sin((t * d - s) * (2 * Math.PI.toFloat()) / p)) + b
                t -= 1
                return a * 2.0.pow((-10 * t).toDouble()).toFloat() * sin((t * d - s) * (2 * Math.PI.toFloat()) / p) * .5f + c + b
            }
        }
        ...
        val easeInOutBounce = object : PenningEasing() {
            override fun invoke(progress: Float): Float {
                return if (progress < d / 2) easeInBounce(progress * 2) * .5f + b
                else easeOutBounce(progress * 2 - d) * .5f + c * .5f + b
            }
        }
