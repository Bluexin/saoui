...
operator fun Vec3d.times(other: Vec3d): Vec3d = this.mul(other)
operator fun Vec3d.times(other: Double): Vec3d = this.mul(other)
...
operator fun Vec3d.div(other: Vec3d) = this.divide(other)
operator fun Vec3d.div(other: Double): Vec3d = this.divide(other)
...
operator fun Vec3d.minus(other: Vec3d): Vec3d = this.sub(other)
