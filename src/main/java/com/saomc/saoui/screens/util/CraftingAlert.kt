...
class CraftingAlert(private val itemStack: ItemStack): IToast {
    ...
    override fun draw(toastGui: GuiToast, delta: Long): IToast.Visibility {
        ...
        toastGui.minecraft.fontRenderer.drawString(I18n.format("notificationCraftingTitle", CraftingUtil.craftLimit * itemStack.count, itemStack.displayName), 25, 12, -11534256)
