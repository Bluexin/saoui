 ...
 * @author Bluexin
 */
class MobColorStateHandler internal constructor(entity: LivingEntity) : IColorStateHandler {
    ...
    private val color: ColorState
        get() {
            ...
            return when {
                ...
                entity is WolfEntity && entity.isAngry -> ColorState.KILLER
                entity is ZombifiedPiglinEntity && entity.isAngry -> ColorState.KILLER
