...
interface NeoElement : INeoParent {
    ...
    fun drawBackground(matrix: MatrixStack, mouse: Vec2d, partialTicks: Float)
    fun draw(matrix: MatrixStack, mouse: Vec2d, partialTicks: Float)
    fun drawForeground(matrix: MatrixStack, mouse: Vec2d, partialTicks: Float)
