...
public class CategoryHelper {
    ...
    private static Class<?>[][] commonTypes =
            {
                    {CategoryEnum.class, CategoryEnum.class}
            };

    @Nullable
    public static CategoryEnum addCategory(String name, CategoryEnum parent)
    {
        return addEnum(CategoryEnum.class, name, parent);
    }
    ...
    private static void setFailsafeFieldValue(Field field, @Nullable Object target, @Nullable Object value) throws Exception
    {
        field.setAccessible(true);
