 ...
 * @author Bluexin
 */
open class IconLabelElement(icon: IIcon, open var label: String = "", override var parent: IElement? = null, override var originPos: Vec2d = Vec2d.ZERO, override var description: MutableList<String> = mutableListOf(), override val init: (IElement.() -> Unit)? = null) : IconElement(icon) {
